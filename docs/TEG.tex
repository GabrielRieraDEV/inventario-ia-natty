...
\noindent\textbf{Cuadro 1}\\
\textit{Operacionalización de la variable}
\addcontentsline{lot}{table}{Cuadro 1. Operacionalización de la variable}
\vspace{4pt}
...
\noindent\textbf{Cuadro 2}\\
\textit{Cronograma de actividades del Trabajo Especial de Grado}
\addcontentsline{lot}{table}{Cuadro 2. Cronograma de actividades del Trabajo Especial de Grado}
\vspace{4pt}
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 1. Frecuencia de errores reportados en el proceso de inventario actual}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 2. Necesidades tecnológicas identificadas, según prioridad}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 3. Requerimientos funcionales del sistema}%
...
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 4. Requerimientos técnicos del sistema}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 5. Módulos del sistema, función y tecnología asociada}%
...
\setstretch{1.0}
\scriptsize
\addcontentsline{lot}{table}{Tabla 6. Matriz de Trazabilidad de Requisitos}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 7. Resultado de las pruebas de reconocimiento mediante la API}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 8. Porcentaje de módulos desarrollados}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 9. Lista de cotejo para la validación del prototipo}%
...
\vspace{6pt}
\setstretch{1.0}
\addcontentsline{lot}{table}{Tabla 10. Costos estimados de desarrollo e implementación}%
